...
def create_model(size_of_vocab, embedding_dim=100, num_hidden_nodes=32, num_output_nodes=3, num_layers=2, dropout=0.2):
...
model = load_latest_model(model, device=device)
